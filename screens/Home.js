      ...
      <View style={styles.inputContainer}>
        ...
        >
          <Ionicons
            ...
            size={30}
            color={
              enteredText !== "" ? (color = "#102b46") : (color = "#acacac")
            }
          />
        </TouchableOpacity>
      </View>
    ...
    <View style={styles.languageSelectContainer}>
      <FlatList
        ...
        renderItem={(itemData) => {
          ...
          return <LanguageItem text={languageString} selected = {languageKey === "ar"} />
        }}
      />
    </View>
  );
    ...
    >
      <Stack.Screen
        ...
        options={{
          headerTitle: (props) => (
            <TouchableOpacity>
              <Octicons name="arrow-switch" size={18} color="#ffff" />
            </TouchableOpacity>
          ),
          headerLeft: (props) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("Language", { title: "Translate from" })
              }
            >
          ...
          headerRight: (props) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("Language", { title: "Translate to" })
              }
            >
